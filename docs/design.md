...
| 前端 | React + TypeScript + Vite + TailwindCSS | 快速开发 + 组件化 + 原子化样式 |
...
当前版本：**0.2.0** （见 `docs/CHANGELOG.md`）
下一步：按 Roadmap Phase 2 推进（User/Role 实体与 API、JWT 认证、前端脚手架）。

## 使用示例

参见 `samples/Berry.Sample/Program.cs`：
